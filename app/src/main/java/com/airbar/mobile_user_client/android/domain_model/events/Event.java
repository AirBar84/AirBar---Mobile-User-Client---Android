...
public class Event {
    ...
    protected UserSession initiatingUser;

    public Event() {
        this(UUID.randomUUID(), new Date(), null, null);
    }

    public Event(UUID eventIdentifier, Date timestamp, Class<? extends Event> eventType, UserSession initiatingUser) {
    ...
    public UserSession getInitiatingUser() {
        return this.initiatingUser;
    }

    public void setInitiatingUser(UserSession initiatingUser) {
        this.initiatingUser = initiatingUser;
    }
}
